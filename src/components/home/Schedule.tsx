  ...
  const scheduleData: Record<string, ClassSession[]> = {
    Monday: [
      ...
      },
      {
        ...
        trainer: "Saikat Mitra",
        category: "Strength",
        room: "Strength Floor",
      },
      {
        time: "07:00 PM - 08:00 PM",
        className: "Combat Agility Fit",
        trainer: "Samar Sen",
        category: "Athletic",
        room: "Combat Box",
      },
    ...
    Tuesday: [
      {
        time: "07:05 AM - 08:00 AM",
        className: "Olympic Barbell Club",
        trainer: "Rohit Sen",
        category: "Strength",
        room: "Main Platform",
      },
      {
        time: "09:30 AM - 10:30 AM",
        className: "Posture Pilates Core",
        trainer: "Somi Sen",
        category: "Mobility",
        room: "Studio B",
      },
      {
        ...
        className: "Athlete Agility Speed",
        trainer: "Rahul Ghosh",
        category: "Athletic",
        room: "Combat Box",
      },
    ...
    Thursday: [
      {
        ...
        className: "Functional Mobility Flow",
        trainer: "Somi Sen",
        category: "Mobility",
        room: "Studio B",
      },
      {
        time: "09:30 AM - 10:30 AM",
        className: "Weight Shred Metabolic",
        trainer: "Diya Roy",
        category: "Cardio",
        room: "Studio A",
      },
      {
        time: "06:15 PM - 07:15 PM",
        className: "Olympic Lifting Technique",
        trainer: "Marcus Evans",
        category: "Strength",
        room: "Main Platform",
      },
    ],
    Friday: [
      ...
      {
        time: "05:30 PM - 06:30 PM",
        className: "Powerlifting Heavy Pro",
        trainer: "Saikat Mitra",
        category: "Strength",
        room: "Strength Floor",
      },
    ...
    Saturday: [
      {
        ...
        className: "Weekend Warrior Blend",
        trainer: "Rohit Sen",
        category: "Athletic",
        room: "Strength Floor",
      },
      {
        ...
        className: "Recovery Deep Stretch",
        trainer: "Anjali Sharma",
        category: "Mobility",
        room: "Studio B",
      },
          ...
          {currentClasses.map((session, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-4 mb-4">
                <span
                  className={`px-2.5 py-0.5 rounded-lg text-xs font-black uppercase border ${categoryColor(session.category)}`}
                >
                  {session.category}
                </span>
